...
class End1Screen extends StatefulWidget {
  const End1Screen({super.key});

  @override
  State<End1Screen> createState() => _End1ScreenState();
}

class _End1ScreenState extends State<End1Screen> {
  @override
  void initState() {
    super.initState();
  }
